...
using MathAnalysisAI.Server.Data.Admin;
using MathAnalysisAI.Server.Data.Courses;
using MathAnalysisAI.Server.Data.Knowledge;
using MathAnalysisAI.Server.Data.Materials;
...
using MathAnalysisAI.Server.Intelligence.PIM;
...
builder.Services.AddScoped<IAuthPersistenceService>(sp => sp.GetRequiredService<AuthPersistenceService>());
builder.Services.AddScoped<ICurrentUserPersistenceService>(sp => sp.GetRequiredService<AuthPersistenceService>());
builder.Services.AddScoped<IPermissionPersistenceService>(sp => sp.GetRequiredService<AuthPersistenceService>());
builder.Services.AddScoped<IIdentityKernel, IdentityKernel>();
...
builder.Services.AddScoped<ILLMModule, LLMGateway>();
builder.Services.AddScoped<ILLMService, LLMService>();
builder.Services.AddScoped<IAnalysisService, AnalysisService>();
builder.Services.AddSingleton<AnalysisPipelineDefinition>();
builder.Services.AddScoped<IAnalysisPipeline, AnalysisPipeline>();
builder.Services.AddScoped<UAOBuilderStep>();
builder.Services.AddScoped<OCRStep>();
builder.Services.AddScoped<LLMStep>();
builder.Services.AddScoped<EvaluationStep>();
...
builder.Services.AddScoped<IPersistenceService>(sp => sp.GetRequiredService<IAnalysisPersistenceService>());
builder.Services.AddScoped<IPromptProfileReader>(sp => sp.GetRequiredService<IAnalysisPersistenceService>());
...
// Application services still exposed as concrete types until dedicated interfaces are introduced.
builder.Services.AddScoped<LeaderboardService>();
builder.Services.AddScoped<PermissionService>();
builder.Services.AddScoped<IAdminPersistenceService, AdminPersistenceService>();
builder.Services.AddScoped<CourseService>();
builder.Services.AddScoped<ICoursePersistenceService, CoursePersistenceService>();
...
builder.Services.AddScoped<ICourseMaterialIngestionPersistenceService, CourseMaterialIngestionPersistenceService>();
...
builder.Services.AddScoped<ILearningPathPersistenceService, LearningPathPersistenceService>();
builder.Services.AddScoped<IWeakPointInsightProjector, WeakPointInsightProjector>();
builder.Services.AddScoped<ILearningPathIntelligenceService, LearningPathIntelligenceService>();
builder.Services.AddScoped<IPersonalStatsIntelligenceService, PersonalStatsIntelligenceService>();
builder.Services.AddScoped<LearningPathService>();
builder.Services.AddScoped<IQuestionModule, QuestionService>();
